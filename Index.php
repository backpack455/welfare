...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">todocode</a>
    ...
    <div class="hero-wrap" style="background-image: url('imagesnew/homepage.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Helping Create Coders One Line At A Time</h1>
    	...
    	<div class="container">
            ...
            <div class="block-18 color-1 align-items-stretch">
              <div class="text">
                ...
                <span>Children in 10 different cities accross Michigan</span>
              </div>
            </div>
          </div>
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-2 align-items-stretch">
              <div class="text">
              	...
              	<p>To help manage our resources and to provide the best education program possible we require funding to keep this free.</p>
          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 color-3 align-items-stretch">
              <div class="text">
              	...
              	<p>Becoming a volunteer is a great way to help the cause. Even if your expertises are not in relation to Computer Science, all help is appreciated.</p>
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 d-flex services p-3 py-4 d-block">
              ...
              <div class="media-body pl-4">
                ...
                <p>Support our cause to teach the world how to code for free by supporting us financially.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 d-flex services p-3 py-4 d-block">
              ...
              <div class="media-body pl-4">
                ...
                <p>Support us by being apart of our volunteer teaching workforce to reach as many kids as possible.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 d-flex services p-3 py-4 d-block">
              ...
              <div class="media-body pl-4">
                ...
                <p>We would love to partner with corporate sponsors. Information regarding sponsorship benefits can be found on the sponsorship page.</p>
              </div>
            </div>    
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
        	<div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#">May 6th, 2020</a></div>
                 
                </div>
                <h3 class="heading mb-4"><a href="#">Basics of Web Design</a></h3>
                <p class="time-loc"><span class="mr-2"><i class="icon-clock-o"></i> 03:00PM-04:00PM</span> <span><i class="icon-map-o"></i>Online Class</span></p>
                <p>Taught by todocode Instructors Robert Silaghi and assistant Instructor Om Joshi, this class will be taught via video calls and Google Classroom. Join to recieve the code. This class will be going over the fundamentals of web design. This class wil run every Wednesday and Saturday for four weeks.</p>
                <p><a href="class1.html">Join Event <i class="ion-ios-arrow-forward"></i></a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text p-4 d-block">
                <div class="meta mb-3">
                  <div><a href="#">May __, 2020</a></div>
                  
                </div>
                <h3 class="heading mb-4"><a href="#">Python for Beginners</a></h3>
                <p class="time-loc"><span class="mr-2"><i class="icon-clock-o"></i> 01:00PM-02:30PM</span> <span><i class="icon-map-o"></i>Online Class</span></p>
                <p id= "1234">Taught by todocode Co-founder and instructor Michael Lu, this class will be taught via Google Classroom and video calls. This class will be learning about the fundamentals of Java. This class will run every Tuesday and Thursday.</p>
                <p><a href="class3.html">Join Event <i class="ion-ios-arrow-forward"></i></a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#">June 4th, 2020</a></div>
                  
                </div>
                <h3 class="heading mb-4"><a href="#">Fundamentals of Java</a></h3>
                <p class="time-loc"><span class="mr-2"><i class="icon-clock-o"></i> 01:00pm-02:00PM</span> <span><i class="icon-map-o"></i>Online Class</span></p>
                <p>Taught by todocode Instructor Wei-Jei Zhou and assistant Instructor Vijay Daita, this class will be going over the fundamentals of Java. This class will run every Wednesday and Thursday for a total of four weeks.</p>
                <p><a href="class2.html">Join Event <i class="ion-ios-arrow-forward"></i></a></p>
              </div>
            </div>
          </div>
    	...
    	<div class="container">
    		...
    		<div class="col-md-6 volunteer pl-md-5 ftco-animate">
    			...
    			<form action="contactform.php" class="volunter-form" method="post">
            ...
            <div class="form-group">
              <input type="text" name="pnumber"class="form-control" placeholder="Your Phone Number">
            </div>
            <div class="form-group">
              <textarea name="write" id="" cols="30" rows="3" class="form-control" placeholder="Please write about your skillset"></textarea>
            </div>
            <div class="form-group">
              <input type="submit" name="submit" value="Send Message" class="btn btn-white py-3 px-5">
            </div>
          </form>
    		</div>    			
    		</div>
  ...
  <script src="js/omJoshi.js"></script>
  </body>
</html>